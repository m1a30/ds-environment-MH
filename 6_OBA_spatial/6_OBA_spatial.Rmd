...
buffer_stats <- data.frame(
  Buffer_Size_km = c(500, 750, 10000),
  Total_Population = c(summary_500$total_population, summary_750$total_population, summary_10000$total_population),
  Total_Land_Area_km2 = c(summary_500$total_land_area, summary_750$total_land_area, summary_10000$total_land_area),
  Avg_Population_Density = c(summary_500$avg_population_density, summary_750$avg_population_density, summary_10000$avg_population_density)
)

ggplot(buffer_stats, aes(x = Buffer_Size_km, y = Total_Population)) +
...
ggplot() +
  geom_sf(data = census_500, fill = "lightblue", alpha = 0.5) +
  geom_sf(data = census_750, fill = "green", alpha = 0.3) +
  geom_sf(data = census_1000, fill = "red", alpha = 0.2) +
  geom_sf(data = vosnesenskii_shp, color = "yellow", size = 0.5) +
  labs(
