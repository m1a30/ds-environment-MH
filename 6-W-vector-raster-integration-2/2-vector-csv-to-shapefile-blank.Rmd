...
This demo will review how to import spatial points stored in `.csv` (Comma
...
We will continue using the `sf` and `terra` packages in this demo.
...
file path: "data/NEON-DS-Site-Layout-Files/HARV/HARV_2NewPhenPlots.csv"

```{r}
newplot_locations_HARV <- read.csv("data/NEON-DS-Site-Layout-Files/HARV/HARV_2NewPhenPlots.csv")
...
```{r}
newPlot_Sp_HARV <- st_as_sf(newplot_locations_HARV,
...
ggplot() + 
  ...
  geom_sf(data=newPlot_Sp_HARV, color ="darkolivegreen") + 
  ggtitle("Map of all the plot locations")
